...
import com.maulanaabdulsiddiq.myuas.response.BeritaItem;
...
class AdapterBerita extends RecyclerView.Adapter<AdapterBerita.MyViewHolder> {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        // Dapatkan url gambar
        final String urlGambarBerita = "http://192.168.29.1/simple-api-portal-berita-master/images/" + berita.get(position).getFoto();
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent varIntent = new Intent(context,DetailBeritaActivity.class);
